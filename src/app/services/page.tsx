...
export const metadata: Metadata = {
  title: 'Our Services',
  description: 'Explore our expert services: Solar Panel Installation, custom Water Fountain Design, and large-scale Turnkey Projects for government and commercial clients.',
};
      ...
      <section className="relative overflow-hidden py-20 text-foreground sm:py-24">
        ...
        <div className="container relative mx-auto px-4 text-center">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-base text-muted-foreground">
                From solar power systems to elegant water fountain designs, we provide end-to-end solutions tailored for homes, businesses, and government projects.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-2">
                <Badge variant="outline" className="border-primary/50 bg-primary/10 text-primary">Solar Installation</Badge>
                <Badge variant="outline" className="border-primary/50 bg-primary/10 text-primary">Water Fountain Design</Badge>
